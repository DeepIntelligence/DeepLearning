...
class RNNStructParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_numhiddenlayers() const;
  inline void clear_numhiddenlayers();
  static const int kNumHiddenLayersFieldNumber = 1;
  inline ::google::protobuf::int32 numhiddenlayers() const;
  inline void set_numhiddenlayers(::google::protobuf::int32 value);

  // optional int32 hiddenLayerInputDim = 2;
  inline bool has_hiddenlayerinputdim() const;
  inline void clear_hiddenlayerinputdim();
  static const int kHiddenLayerInputDimFieldNumber = 2;
  inline ::google::protobuf::int32 hiddenlayerinputdim() const;
  inline void set_hiddenlayerinputdim(::google::protobuf::int32 value);

  // optional int32 hiddenLayerOutputDim = 3;
  inline bool has_hiddenlayeroutputdim() const;
  inline void clear_hiddenlayeroutputdim();
  static const int kHiddenLayerOutputDimFieldNumber = 3;
  inline ::google::protobuf::int32 hiddenlayeroutputdim() const;
  inline void set_hiddenlayeroutputdim(::google::protobuf::int32 value);
