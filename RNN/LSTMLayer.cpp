...
LSTMLayer::LSTMLayer(std::shared_ptr<arma::mat> trainingX0, std::shared_ptr<arma::mat> trainingY0,
...
void LSTMLayer::initializeWeight(){
...
void LSTMLayer::forwardPass(std::shared_ptr<arma::mat> X) {
